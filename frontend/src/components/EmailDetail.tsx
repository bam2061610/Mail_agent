    ...
    <div className="modal-overlay" role="dialog" aria-modal="true" aria-label={props.mode === "reply" ? t("detail.replyTitle") : t("detail.readTitle")} onMouseDown={props.onClose}>
      <div className="modal-card email-modal" onMouseDown={(event) => event.stopPropagation()}>
        ...
        {props.loading ? (
          ...
          <div className={`modal-body${props.mode === "reply" ? " modal-body-reply" : ""}`}>
            <div className="detail-summary">
              <div className="summary-heading">{t("detail.summaryHeading")}</div>
              <p>{summaryText || t("detail.noAnalysis")}</p>
              <div className="summary-grid">
                <SummaryPoint label={t("detail.reply")} value={props.replyLanguage.toUpperCase()} />
                <SummaryPoint label={t("detail.attachmentsTitle")} value={props.attachments.length} />
                ...
                {props.mode === "reply" ? (
                  ...
                  <div className="read-panel">
                    <div className="read-actions">
                      ...
                      <button className="button button-primary" type="button" onClick={() => props.onModeChange("reply")}>
                        {t("detail.replyNow")}
                      </button>
                    </div>
                    <div className="read-preview">
                      <Field label={t("detail.reply")} full hint={t("detail.replyHint")}>
                        <p className="read-preview-copy">{props.selectedEmail?.ai_draft_reply || props.selectedEmail?.body_text || props.selectedEmail?.body_html || t("queue.noPreview")}</p>
                      </Field>
